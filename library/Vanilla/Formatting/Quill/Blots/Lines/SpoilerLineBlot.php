...
class SpoilerLineBlot extends AbstractLineBlot {
    ...
    public function getGroupOpeningTag(): string {
        ...
        return $this->parseMode === Parser::PARSE_MODE_QUOTE ? '' : "<div class=\"$wrapperClass\">$button<div class=\"$contentClass\">";
    }
    ...
    public function renderLineStart(): string {
        return $this->parseMode === Parser::PARSE_MODE_QUOTE ? '' : '<p class="spoiler-line">';
    }
    ...
    public function renderLineEnd(): string {
        return $this->parseMode === Parser::PARSE_MODE_QUOTE ? '' : '</p>';
    }
